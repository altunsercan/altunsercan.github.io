<template>
  <Layout>
    <div class="hero container-inner mx-auto flex flex-col sm:flex-row justify-between py-10">
      <div class="flex-1 text-4xl font-bold w-full text-center sm:text-left sm:mt-10 lg:mt-16 relative">
        <div class="leading-tight">Sercan Altun</div>
        <div class="text-green-700 leading-tight">Gameplay & AI Programmer</div>
      </div>
      <div class="flex-1 lg:flex-none mt-8 sm:mt-0">
        <g-image src="../../static/sercan-altun.jpg" alt="hero" class="w-64 mx-auto lg:mx-0" />
      </div>
    </div> <!-- end hero -->
    ...
    <div class="overflow-x-hidden">
      <div class="projects container-inner mx-auto text-xl border-t border-gray-500 /*border-b*/ py-16 mb-16 relative">
        <h2 class="font-bold mb-6" id="projects">Some highlighted work experience:</h2>
        ...
        <ul class="text-lg sm:text-xl">
          <li class="checkmark mb-6">
            <div>Gameloft Montreal <span class="italic text-sm text-gray-500">Gameplay & AI Programmer</span></div>
            <div class="text-lg text-gray-600">
              Currently working on an undisclosed project.
              <ul class="list-disc list-outside pl-6">
                <li> Developing character AI for dungeon crawling style gameplay. Worked on creating a modular behavior tree design that would support AI customization based on skills.</li>
                <li> Worked as product owner of a Scrum team. Organizing sprint planning meetings and daily standups.</li>
              </ul>
            </div>
          </li>

          <li class="checkmark mb-6">
            <div>Game Hive <span class="italic text-sm text-gray-500">Mobile Developer</span></div>
            <div class="text-lg text-gray-600">
              Worked as a mobile game developer in client-side team for company's flagship game Tap Titans 2.
              <ul class="list-disc list-outside pl-6">
                <li> Developed new features for the game and helped with code maintenance in Unity (C#). </li>
                <li> Introduced patching techniques to improve testing process of server endpoints. Eliminated the need for introducing temporary testing code into main code base. </li>
                <li> Profiled memory and CPU usage using Unity Profiler; found performance issues and resolved memory spike crashes. </li>
              </ul>
            </div>
          </li>
        </ul>
...
export default {
  metaInfo: {
    title: 'Game Developer - Sercan Altun: Unity3D, C#, Game AI, Extenject',
    meta: [
